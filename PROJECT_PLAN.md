...
- [x] Chaos deterministic testing with `CHAOS_SEED`
...
- [ ] Mobile viewport — second Playwright project (`mobile-chrome`, `devices['Pixel 7']`); existing UI tests re-run automatically; tag viewport-sensitive tests `@mobile`
